...
SECRET_KEY = 'django-insecure-=$e4oczt@ur*-itj((s9qr_s_2!yw2euaj30y*3g(6#i*$tp5i'
...
# --- CONFIGURAÇÕES DO JAZZMIN (PAINEL DE ADMINISTRAÇÃO) ---
JAZZMIN_SETTINGS = {
    "site_title": "Gestão do Salão",
    "site_header": "Painel de Gestão",
    "site_brand": "Duo Space Cabeleireiro",
    "site_logo": "logo.png",
